    ...
    >
      ...
      <div className="relative mx-auto max-w-[1280px] px-5 sm:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-10 xl:gap-16">
          ...
          >
            <div className="relative flex min-h-[420px] items-center justify-center sm:min-h-[480px] lg:min-h-[520px]">
              <img className="" src="https://res.cloudinary.com/dzwto9zbu/image/upload/v1780731114/ChatGPT_Image_Jun_6_2026_01_01_22_PM_n2llfm.png" alt="" />
