...
export default function CheckoutModal({ open, onClose }) {
        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full sm:max-w-[920px] mx-auto rounded-t-3xl sm:rounded-3xl glass-strong overflow-hidden max-h-[88dvh] sm:max-h-[92vh] flex flex-col"
            >
              {/* Glow */}
  ...
  <div className="text-right">
    <span
      ...
      className="font-display text-4xl font-semibold leading-none text-gradient-luxe"
    >
      ₹{netPrice}
    </span>
  </div>
